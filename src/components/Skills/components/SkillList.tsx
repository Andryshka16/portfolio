...
const SkillList = ({ title, skills }: SkillListProps) => {
    ...
    return (
        <div className='m-auto w-[420px] rounded-[32px] bg-gray-200 px-12 pb-6 dark:bg-[#2A2A67]'>
            <h1 className='my-5 text-center text-4xl font-bold text-zinc-800 dark:text-white'>
                {title}
            </h1>
                ...
                {skills.map(({ skill, level }) => (
                    <div className='flex gap-2' key={skill}>
                        ...
                        <div className='h-fit w-fit'>
                            ...
                            <h3 className='text-md font-bold text-zinc-600 dark:text-white dark:text-opacity-50'>
                                {skillLevels[level]}
                            </h3>
                        </div>
                    </div>
